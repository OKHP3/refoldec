...
|---|---|---|---|
| Node.js | `.replit`: `nodejs-24`; local `24.11.1`; live Replit `24.13.0`; former CI selector `lts/*` | **24.21.0 LTS**; **26.9.0 Current** ([Node release index](https://nodejs.org/dist/index.json)) | `.node-version` now targets `24.21.0`; weekly tested PRs follow latest LTS, including a new LTS major. Current is recorded separately. |
